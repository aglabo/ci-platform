#!/usr/bin/env bash
# src: ./.github/actions/ca-validate-environment/scripts/__tests__/is-safe-regex.spec.sh
...
Describe 'is_safe_regex()'
  SCRIPT_PATH="${SHELLSPEC_PROJECT_ROOT}/.github/actions/ca-validate-environment/scripts/validate-apps.sh"
