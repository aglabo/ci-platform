...
# src: ./.github/actions/ca-validate-environment/scripts/__tests__/validate-apps/integration/validate-apps-orchestrator.integration.spec.sh
# @(#) : Integration tests for validate_apps() orchestration in validate-apps.sh

Describe 'validate_apps()'
  SCRIPT_DIR="${SHELLSPEC_PROJECT_ROOT}/.github/actions/ca-validate-environment/scripts"
