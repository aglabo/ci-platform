...
設計思想の詳細は [コア哲学](./01-core-philosophy.ja.mdx) を参照してください。
...
Gate パターンの詳細は [ゲートパターン](./02-gate-pattern.ja.mdx) を参照してください。
...
ci-platform を **利用するだけ** の場合は [ユーザーガイド](../user-guide/index.ja.mdx) を参照してください。
...
- [コア哲学](./01-core-philosophy.ja.mdx): ci-platform の設計思想と品質自動化の考え方
- [ゲートパターン](./02-gate-pattern.ja.mdx): ゲートチェックパターンと validate-environment の実装
- [アーキテクチャ](./03-architecture.ja.mdx): コンポーネント構成と CI/CD フロー全体像
- [デザインプリンシプル](./04-design-principles.ja.mdx): 実装の設計原則と拡張ガイドライン
