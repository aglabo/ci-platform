...
| 番号 | ファイル名               | 内容                                                  |
| ---- | ------------------------ | ----------------------------------------------------- |
| 20   | [スクリプトリファレンス] | scripts/ 配下の関数・引数・使用方法リファレンス       |
| 30   | [GitHub Actions 設計]    | Composite Action / Reusable Workflow の設計と拡張方法 |

### 設定・品質管理

| 番号 | ファイル名         | 内容                                                       |
| ---- | ------------------ | ---------------------------------------------------------- |
| 40   | [設定ガイド]       | 品質ツール設定ガイド (commitlint / gitleaks / textlint 等) |
| 60   | [品質パイプライン] | ローカル品質管理 + CI パイプライン全体説明                 |
