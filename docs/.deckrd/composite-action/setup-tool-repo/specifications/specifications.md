...
| DD-03 | Node.js デフォルト `"22"`、pnpm デフォルト `"11.22.0"`          | プロジェクト既存実績値に準拠                     | R-005, R-006   | Active |
...
| `pnpm-version` | No       | 任意の pnpm バージョン文字列                                      | `"11.22.0"` |
...
| R-010   |    2 | `pnpm-version` 未指定       | デフォルト `"11.22.0"` を使用 |
